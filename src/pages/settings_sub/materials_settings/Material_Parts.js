...
import AddMaterialPart from "./Add_Material_Part";
import Footer from "../../components/Footer";
import { Overlay } from "../../components/Overlay";
const postsRow = [
  {
    id: 1,
    Des: "Description of Material or Part",
    UOM: "Active",
    Price: "Active",
    Vendor: "Active",
    Group: "NC DOT",
...
function searchFilter(search) {
  return function(x) {
    return x.Vendor.toLowerCase().includes(search.toLowerCase()) || !search;
  };
}
class MaterialParts extends Component {
  state = {
    active: false,
    show: false,
    condition: false,
