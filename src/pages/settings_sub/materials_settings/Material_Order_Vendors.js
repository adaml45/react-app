...
import AddMaterialOrderVendor from "./Add_Material_Order_Vendor";
...
class MaterialOrderVendors extends Component {
  state = {
    active: false,
    show: false,
    condition: false,
...
`;
export default MaterialOrderVendors;
